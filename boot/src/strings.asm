b1_s_title: db "JAIDEOS BOOTLOADER (v0.02)                                             hi marko!", 10, 0
...
b1_s_enter_menu: db 10, "hello from 0x0000:0x1000!", 10, "press ESCAPE to enter the bootloader menu.", 0

b1_s_navbar_text: db "[ LOAD KERNEL ]   [ RESET ]   [ PANIC ]   [ DO NOTHING ]", 0
b1_s_load_finished: db 10, "use the ARROW KEYS to select an action. ", 10, "press ENTER to execute the selected action.", 10, 0
